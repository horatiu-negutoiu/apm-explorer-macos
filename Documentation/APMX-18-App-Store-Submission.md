...
1. Launch APM Explorer and select its menu bar icon.
2. Select **Allow Input Monitoring**. If macOS directs you to System Settings,
   open **Privacy & Security → Input Monitoring**, enable APM Explorer, and
   return to the app.
3. Select **Check Again**. If the panel says a relaunch is required, select
   **Relaunch APMX** and reopen the menu bar item.

...
final class PassiveInputCaptureModel: ObservableObject {
    ...
    // Nil until a real, unsuspended passive check and capture reconciliation
    // finish. Saved history alone must never trigger startup onboarding.
    @Published private(set) var initialPermissionState: InputMonitoringPermissionState?
